...
بعد از XGBoost و AdaBoost استفاده کنید و با اونها مقایسه کنید

بعد با استفاده از Stack generalization ببینید دقت ترکیب همشون بهتر از تک تکشون میشه یا نه

نهایتا چند روش عمیق را روش تست و با قبلیها مقایسه کنید
